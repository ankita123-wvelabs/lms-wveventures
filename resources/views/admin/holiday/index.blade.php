...
<!--dynamic table initialization -->
	...
	<script type="text/javascript">
		...
		var type = "warning";
		var delete_path = "{{ URL::route('admin.holidays.delete') }}";
		...
		// {
		    var dataTable = $('#dataTable').dataTable({
		        ...
		        "sAjaxSource": "{{ URL::route('admin.holidays.index') }}",
		        ...
		        { "mData": "date",sWidth: "20%",bSortable: true,},
		        { "mData": "info",sWidth: "20%",bSortable: true,},
		        { "mData": "image",sWidth: "20%",bSortable: false,
	                sClass: 'text-center',
	                mRender: function(v, t, o) 
	                {
	                    if(v) {
	            ...
	            },
		        {
		            ...
		            mRender: function(v, t, o) {
		                ...
		                var editurl = '{{ route("admin.holidays.edit", ":id") }}';
