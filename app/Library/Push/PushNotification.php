...
class PushNotification 
{
	...
	private static $API_ACCESS_KEY = 'AIzaSyA9gKnReC2HacaF6OiXxGoRTZq6Q2Yj4kM';
	...
	public static function iOS($data, $deviceToken) 
	{
		...
		stream_context_set_option($ctx, 'ssl', 'local_cert', public_path('application_file').'/'.'lms_dev_apns.pem');
		...
		$fp = stream_socket_client(
			'ssl://gateway.sandbox.push.apple.com:5223', $err,
